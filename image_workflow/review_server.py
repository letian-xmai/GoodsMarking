...
function updateActionButton(){const rawCount=Object.keys(rawAdjustments).length;if(activeView==='original'){submit.textContent=`提交调整 ${rawCount} 张`;submit.disabled=rawCount===0;return;}submit.textContent='提交本商品';submit.disabled=!images.length;updateFinalStats();}
