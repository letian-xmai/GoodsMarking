...
.top{position:sticky;top:0;background:rgba(255,255,255,.96);border-bottom:1px solid var(--slate-200);padding:16px 20px;z-index:2;box-shadow:0 8px 28px rgba(15,23,42,.06);backdrop-filter:saturate(140%) blur(10px)}.menu{display:flex;gap:8px;margin-bottom:14px}.menu button,button.secondary{background:white;color:var(--slate-700);border-color:#cbd5e1}.menu button.active{background:var(--blue-600);color:white;border-color:var(--blue-600);box-shadow:0 6px 16px rgba(37,99,235,.22)}
.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(132px,1fr));gap:12px}.metric{border:1px solid var(--slate-200);background:linear-gradient(180deg,#fff,#f8fbff);border-radius:8px;padding:12px 14px;color:var(--slate-500)}.metric b{display:block;margin-top:2px;font-size:26px;line-height:1.1;color:var(--slate-900);font-variant-numeric:tabular-nums}.metricButton{min-height:auto;text-align:left}.metricButton:hover,.metricButton.active{background:var(--blue-50);border-color:var(--blue-600);box-shadow:0 0 0 2px rgba(37,99,235,.12)}.productbar{display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-top:14px}.product{font-size:16px;font-weight:700;color:var(--slate-900)}.status{display:inline-flex;align-items:center;border:1px solid #bfdbfe;border-radius:999px;padding:4px 10px;background:var(--blue-50);color:#1e40af}.hint{color:var(--slate-500);font-size:13px}
